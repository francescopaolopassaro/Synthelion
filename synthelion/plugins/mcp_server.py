...
_READ_ONLY_TOOLS = frozenset({
    ...
    "safety_check", "check_sensitive_content", "check_enterprise_guard", "check_agent_policy", "describe_agent_policy", "check_compliance", "compliance_status", "analyze_waste", "check_cache_alignment", "align_cache_prompt", "shape_output",
